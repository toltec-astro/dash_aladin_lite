...
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/dash_aladin_lite@0.0.1/dash_aladin_lite/dash_aladin_lite.min.js",
    dynamic = nothing,
    async = nothing,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/dash_aladin_lite@0.0.1/dash_aladin_lite/dash_aladin_lite.min.js.map",
    dynamic = true,
    async = nothing,
    type = :js
),
